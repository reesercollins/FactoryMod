...
public interface IPowerManager {
	...
	/**
	 * @return Internal counter to count up until power needs to be consumed while a
	 *         factory is running. Should be in ticks
	 */
	 ...
	 * great care and try to use {@link #increasePowerCounter()} instead if possible
	 * 
